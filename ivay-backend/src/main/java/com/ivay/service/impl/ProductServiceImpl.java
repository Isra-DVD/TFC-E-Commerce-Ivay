...
import com.ivay.mappers.cartitem.CartItemMapper;
...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductResponseDto updateProduct(Long productId, ProductRequestDto productRequestDto) {
        ...
        if (!Objects.equals(product.getCategory() != null ? product.getCategory().getId() : null, productRequestDto.getCategoryId())) {
             log.info("Updating category for product {}", productId);
             Category category = validateAndGetCategory(productRequestDto.getCategoryId());
             product.setCategory(category);
        }
         if (!Objects.equals(product.getSupplier() != null ? product.getSupplier().getId() : null, productRequestDto.getSupplierId())) {
    ...
    public void deleteProduct(Long productId) {
        ...
        if ((product.getOrderItems() != null && !product.getOrderItems().isEmpty()) ||
            ...
            throw new IllegalStateException("Cannot delete product associated with existing orders or carts. Please remove associations first.");
        }
