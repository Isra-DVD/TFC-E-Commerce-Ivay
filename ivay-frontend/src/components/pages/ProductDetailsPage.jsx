                        ...
                        <Box sx={{ my: 3 }}>
                            {originalPrice && (
                                <Typography
                                    ...
                                    sx={{ textDecoration: "line-through", display: "inline-block", mr: 1.5, fontSize: '1.1rem' }}
                                >
                                    PVPR: €{originalPrice}
                                </Typography>
                            )}
                            <Typography variant="h4" component="p" color="primary.main" fontWeight="bold" sx={{ display: "inline-block" }}>
