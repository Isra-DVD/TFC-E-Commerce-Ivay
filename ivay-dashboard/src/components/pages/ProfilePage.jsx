...
const ProfilePage = () => {
    ...
    useEffect(() => {
        if (user) {
            ...
            setError("No se pudo cargar la información del perfil o no estás autenticado.");
        }
    }, [user]);
    ...
    if (!user) {
        return (
            <Paper sx={{ p: 3, maxWidth: 600, mx: 'auto', mt: 4, textAlign: 'center' }}>
    ...
    return (
        <>
            <Typography variant="h5" component="h1" gutterBottom fontWeight="bold" sx={{ textAlign: 'center', mb: 3 }}>
                Mi Perfil (Gestor)
            </Typography>
            <Paper sx={{ p: { xs: 2, sm: 3 }, maxWidth: 600, mx: 'auto' }}>
                ...
                <Box component="div" sx={{ mb: 4 }}>
                    ...
                    <Button
                        ...
                        fullWidth
                    >
                        {savingDetails ? <CircularProgress size={24} color="inherit" /> : "Guardar Detalles"}
                    </Button>
                </Box>
